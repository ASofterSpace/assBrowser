...
A general entrypoint to files and folders on a computer, modeled after the good old datacom x
...
To start up the assBrowser project after it has been built, you can call under Windows:
